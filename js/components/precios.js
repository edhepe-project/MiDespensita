    ...
    <div id="lista-precios" style="margin-bottom: var(--space-4);">
      ${productosConPrecios.length === 0
        ? `<div class="empty-state">
             <div style="width:72px; height:72px; margin: 0 auto 16px; background:var(--orange-50); border-radius:50%; display:flex; align-items:center; justify-content:center; color:var(--primary);">
               <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                 <line x1="12" y1="1" x2="12" y2="23"></line>
                 <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>
               </svg>
             </div>
             <p style="font-weight:600; color:var(--text); margin-bottom:8px; font-size: 16px;">Aún no hay historial de precios</p>
             <p class="text-secondary" style="font-size:13px; max-width:240px; margin:0 auto; line-height: 1.5;">Registra tus compras en la sección Historial para ver tus análisis y comparativas aquí.</p>
           </div>`
